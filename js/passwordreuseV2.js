...
const passwordMachine = XState.Machine({initial: "idle", context, states: {idle:
  ...
  CHANGE: {internal: true}}, initial: "normal", states: {normal: {}, error: {after: {}}}},
...
elRndm.addEventListener('click', () => send("SUBMIT"));
...
function validation() {
  ...
  // alert("Account Created! Login credentials has been saved in your vault");
  // location.reload();
  setTimeout(function(){ alert("Account Created! Login credentials has been saved in your vault"); }, 800);
...
function checkInputs() {
  ...
  if (passValue == "") {
    ...
    setErrorFor(passwordfield, "Use a random generated password. It'll be saved in your vault!");
  }
  else {
